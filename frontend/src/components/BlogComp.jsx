...
const BlogComp = ({ title, body, author, isFirst }) => {
    return (
        <div className={`${isFirst ? "mt-10" : ""} p-8 hover:bg-slate-200 hover:rounded-xl hover:transition-colors hover:duration-200 hover:ease-in`}>
            <div className="font-oswald flex">
                <h2 className="text-3xl w-full pb-10 underline underline-offset-4">{title}</h2>
